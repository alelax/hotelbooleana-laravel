    ...
    <div class="container px-0">
        <div class="row no-gutters d-flex justify-content-between align-items-center">
            ...
            <div class="heading-cnt col-8 col-md-5 col-lg-4 d-flex align-items-center justify-content-between">
                ...
                <div class="hotel-name col-6 col-md-8 d-none d-md-block">Booleana Hotel 
            ...
            <div class="nav-items-cnt col-3 col-md-7 col-lg-7 d-flex align-items-center justify-content-around">
                ...
                <div class="nav-item"> <a href="">Spa</a> </div>

                <div class="hamburger-menu-icon text-center col-10 px-0 mx-auto d-flex align-items-center d-md-none">
                    <i class="fa fa-bars fa-3x mx-auto"></i>
                </div>
            </div>
